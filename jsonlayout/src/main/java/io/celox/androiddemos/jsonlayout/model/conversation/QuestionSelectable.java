...
public abstract class QuestionSelectable extends Question {

    private String selectedItem;

    public QuestionSelectable(int id, int position, String description, int mandatory, String keyword) {
