...
package io.celox.androiddemos.btconnection;
...
public class MainActivity extends AppCompatActivity implements BluetoothBroadcastReceiver.Callback,
        BluetoothA2DPRequester.Callback {
     ...
     * your device.
     */
    private static final String BLUETOOTH_DEVICE_NAME = "Bose Mini II SoundLink";
    ...
    public void onA2DPProxyReceived(BluetoothA2dp proxy) {
        ...
        BluetoothDevice device = findBondedDeviceByName(mAdapter, BLUETOOTH_DEVICE_NAME);
